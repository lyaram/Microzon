...
# - lanzar ejecucion con bash <nombrefichero>
    ...
    page.launch idLaunch,'RESTALO_RestList.LA_RIOJA', 'http://www.restalo.es/restaurantes-la-rioja', '//div[@id="pagerContainerList"]/ul[@id="pager"]/li[@class="last"]/a', '//div[@id="pagerContainerList"]', ''
    page.launch idLaunch,'ATRAPALO_RestList.LA_RIOJA', 'http://www.atrapalo.com/restaurantes/la-rioja_d18.html', '//*[@id="resultados_restaurantes"]//a[@title="Siguiente"]', '//div[@id="resultados_restaurantes"]/div[@class="pagerResultsBox margintop10"]', ''
    ...
    page.launch idLaunch,'BUSCORESTAURANTES_RestList.LA_RIOJA', 'http://www.buscorestaurantes.com/Restaurantes-en-Logrono-1-31-1902/1-1.html', '//div[@class="block-pagination"]/a[text()="Siguiente"]', '//div[@class="block-pagination"]', ''
    page.launch idLaunch,'BUSCORESTAURANTES_RestList.LA_RIOJA', 'http://www.buscorestaurantes.com/Restaurantes-en-Calahorra-1-31-1888/1-1.html', '//div[@class="block-pagination"]/a[text()="Siguiente"]', '//div[@class="block-pagination"]', ''
    page.launch idLaunch,'BUSCORESTAURANTES_RestList.LA_RIOJA', 'http://www.buscorestaurantes.com/Restaurantes-en-Haro-1-31-1898/1-1.html', '//div[@class="block-pagination"]/a[text()="Siguiente"]', '//div[@class="block-pagination"]', ''
    page.launch idLaunch,'BUSCORESTAURANTES_RestList.LA_RIOJA', 'http://www.buscorestaurantes.com/Restaurantes-en-Ezcaray-1-31-1896/1-1.html', '//div[@class="block-pagination"]/a[text()="Siguiente"]', '//div[@class="block-pagination"]', ''
    page.launch idLaunch,'BUSCORESTAURANTES_RestList.LA_RIOJA', 'http://www.buscorestaurantes.com/Restaurantes-en-Najera-1-31-1903/1-1.html', '//div[@class="block-pagination"]/a[text()="Siguiente"]', '//div[@class="block-pagination"]', ''
