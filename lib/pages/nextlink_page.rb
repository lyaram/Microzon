...
#         con.query("INSERT tblLastPage (lastpage) VALUES ('#{@browser.element(:xpath,"//*[@id='REVIEWS']//*[contains(@class,'pageNum current')]").text.strip}');")
        ...
        nodes.each do |node|
          ...
          ignore_exception { nacionality = con.quote(node.element(:xpath,".//span[@itemprop='nationality']/span").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewDate = con.quote(node.element(:xpath,"./p[@class='review_item_date']").text).to_s.force_encoding('UTF-8') }
          ignore_exception { score = con.quote(node.element(:xpath,".//*[@class='review-score-badge']").text).to_s.force_encoding('UTF-8') }
          ...
          ignore_exception { reviewInfoTag01 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[1]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag02 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[2]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag03 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[3]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag04 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[4]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag05 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[5]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag06 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[6]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag07 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[7]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag08 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[8]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag08 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[8]").text).to_s.force_encoding('UTF-8') }
          ignore_exception { reviewInfoTag08 = con.quote(node.element(:xpath,".//ul[@class='review_item_info_tags']/li[8]").text).to_s.force_encoding('UTF-8') }
