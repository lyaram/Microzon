...
#          ignore_exception { value02_Value = con.quote(@browser.element(:xpath,"//select[@id='review_score_filter']/option[@data-dist='5']").text) }
          ...
          ignore_exception { medidasSaludSeguridad = con.quote(node.element(:xpath,"//*[contains(@data-modal-id,'safety')]/div").attribute_value('textContent')) }
