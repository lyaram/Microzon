...
ahora = Time.now;  tiempopasado = ahora.to_f - @lasttime; @lasttime = ahora.to_f; puts("CODETRACE (#{ahora}, +#{(tiempopasado * 1000).to_i}ms)>> #{__FILE__}:#{__LINE__}"); $stdout.flush
      ...
      if descripcion.include? '.PickIndivFromSelection'
        ...
        @browser.goto "https://#{uri.host}/SetLangFilter?returnTo=%2f&filterLang=ALL"
      end
...
ahora = Time.now;  tiempopasado = ahora.to_f - @lasttime; @lasttime = ahora.to_f; puts("CODETRACE (#{ahora}, +#{(tiempopasado * 1000).to_i}ms)>> #{__FILE__}:#{__LINE__}"); $stdout.flush
    ...
    if (descripcion.include? 'GMapsReviewBox.') &&  !(url.include? 'file:///')
...
#            ignore_exception { placeName = con.quote(node.element(:xpath,".//*[@class='location'] | .//a[contains(@class,'restaurantName')]").text) }
            ignore_exception { placeName = con.quote(node.element(:xpath,".//span/div[1]/div[2]/div[1]//span/a").text) }
#            ignore_exception { placeLink = con.quote(node.element(:xpath,"./a | .//a[contains(@class,'restaurantName')]").attribute_value('href')) }
            ignore_exception { placeLink = con.quote(node.element(:xpath,".//span/div[1]/div[2]/div[1]//span/a").attribute_value('href')) }
...
#INTRODUCIR PATH COLECCIÓN ITEMS
      ...
      h12 = ""
          ...
          ignore_exception { placeName = con.quote(node.element(:xpath,"//*[@id='HEADING']").attribute_value('textContent')) }
          ignore_exception { award_text = con.quote(node.element(:xpath,"(//img[contains(@class,'Award')])[1]").attribute_value('alt')) }
          ignore_exception { award_class = con.quote(node.element(:xpath,"(//img[contains(@class,'Award')])[1]").attribute_value('class')) }
          ...
          ignore_exception { currentPage = con.quote(node.element(:xpath,".//*[@class='pageNum current']").attribute_value('textContent')) }
          ignore_exception { placeType2 = con.quote(node.element(:xpath,"//*[starts-with(@class,'header_detail')]").attribute_value('textContent')) }
          ignore_exception { langList = con.quote(node.element(:xpath,"//*[@id='filterLang']/option/@value").attribute_value('value')) }
          ignore_exception { langSelected = con.quote(node.element(:xpath,"//*[@data-prwidget-name='filters_detail_language' or @class='ui_column is-3 language']//input[./@checked and not(ancestor-or-self::*[contains(./@class,'hidden')])]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { segmSelected = con.quote(node.element(:xpath,".//*[@id='filterControls']//*[contains(@class,'segment')]/ul/li[./span/input/@checked]/label").attribute_value('textContent')) }
          ignore_exception { filterSegment = con.quote(node.element(:xpath,"//span[@class='filter']").attribute_value('textContent')) }
          ignore_exception { filterCount = con.quote(node.element(:xpath,"//span[@class='filter']/preceding-sibling::b[1]").attribute_value('textContent')) }
          ...
          ignore_exception { timeOfYear4_Count = con.quote(node.element(:xpath,"//*[starts-with(@class,'col season')]/ul/li[4]/label").attribute_value('textContent')) }
          ignore_exception { varDimField1 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[1]").attribute_value('textContent')) }
          ...
          ignore_exception { varDimField2 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[2]").attribute_value('textContent')) }
          ...
          ignore_exception { varDimField3 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[3]").attribute_value('textContent')) }
          ...
          ignore_exception { varDimField4 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[4]").attribute_value('textContent')) }
          ...
          ignore_exception { varDimField5 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[5]").attribute_value('textContent')) }
          ...
          ignore_exception { varDimField6 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[6]").attribute_value('textContent')) }
          ...
          ignore_exception { varDimField7 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[7]").attribute_value('textContent')) }
          ignore_exception { varDimField7Val = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/span/span | //*[@class='ratingSummary wrap']//li//span)[7]").attribute_value('alt')) }
          ignore_exception { varDimField8 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[8]").attribute_value('textContent')) }
          ignore_exception { varDimField8Val = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/span/span | //*[@class='ratingSummary wrap']//li//span)[8]").attribute_value('alt')) }
          ignore_exception { varDimField9 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[9]").attribute_value('textContent')) }
          ignore_exception { varDimField9Val = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/span/span | //*[@class='ratingSummary wrap']//li//span)[9]").attribute_value('alt')) }
          ignore_exception { varDimField10 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[10]").attribute_value('textContent')) }
          ignore_exception { varDimField10Val = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/span/span | //*[@class='ratingSummary wrap']//li//span)[10]").attribute_value('alt')) }
          ignore_exception { varDimField11 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[11]").attribute_value('textContent')) }
          ignore_exception { varDimField11Val = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/span/span | //*[@class='ratingSummary wrap']//li//span)[11]").attribute_value('alt')) }
          ignore_exception { varDimField12 = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/div | //*[@class='ratingSummary wrap']//li//span[@class='text'])[12]").attribute_value('textContent')) }
          ignore_exception { varDimField12Val = con.quote(node.element(:xpath,"(//*[@id='SUMMARYBOX']/ul/li/span/span | //*[@class='ratingSummary wrap']//li//span)[12]").attribute_value('alt')) }
          ignore_exception { varSegmField1 = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[1]/div/div[1]").attribute_value('textContent')) }
          ignore_exception { varSegmField1Val = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[1]/div/div[2]").attribute_value('textContent')) }
          ignore_exception { varSegmField2 = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[2]/div/div[1]").attribute_value('textContent')) }
          ignore_exception { varSegmField2Val = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[2]/div/div[2]").attribute_value('textContent')) }
          ignore_exception { varSegmField3 = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[3]/div/div[1]").attribute_value('textContent')) }
          ignore_exception { varSegmField3Val = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[3]/div/div[2]").attribute_value('textContent')) }
          ignore_exception { varSegmField4 = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[4]/div/div[1]").attribute_value('textContent')) }
          ignore_exception { varSegmField4Val = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[4]/div/div[2]").attribute_value('textContent')) }
          ignore_exception { varSegmField5 = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[5]/div/div[1]").attribute_value('textContent')) }
          ignore_exception { varSegmField5Val = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[5]/div/div[2]").attribute_value('textContent')) }
          ignore_exception { varSegmField6 = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[6]/div/div[1]").attribute_value('textContent')) }
          ignore_exception { varSegmField6Val = con.quote(node.element(:xpath,"(//*[@class='trip_type']/div[starts-with(@class,'segment')])[6]/div/div[2]").attribute_value('textContent')) }
          ignore_exception { codeMap = con.quote(node.element(:xpath,"//*[contains(@src,'center=')]").attribute_value('src')) }
          ignore_exception { peineNotas5 = con.quote(node.element(:xpath,"(//*[contains(text(),'ler rating')]/..//input[1])[1]").attribute_value('checked')) }
          ignore_exception { peineNotas4 = con.quote(node.element(:xpath,"(//*[contains(text(),'ler rating')]/..//input[1])[2]").attribute_value('checked')) }
          ignore_exception { peineNotas3 = con.quote(node.element(:xpath,"(//*[contains(text(),'ler rating')]/..//input[1])[3]").attribute_value('checked')) }
          ...
          ignore_exception { varLangField01Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[01]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField02 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[02]").attribute_value('value')) }
          ignore_exception { varLangField02Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[02]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField03 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[03]").attribute_value('value')) }
          ignore_exception { varLangField03Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[03]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField04 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[04]").attribute_value('value')) }
          ignore_exception { varLangField04Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[04]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField05 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[05]").attribute_value('value')) }
          ignore_exception { varLangField05Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[05]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField06 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[06]").attribute_value('value')) }
          ignore_exception { varLangField06Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[06]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField07 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[07]").attribute_value('value')) }
          ignore_exception { varLangField07Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[07]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField08 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[08]").attribute_value('value')) }
          ignore_exception { varLangField08Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[08]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField09 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[09]").attribute_value('value')) }
          ignore_exception { varLangField09Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[09]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField10 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[10]").attribute_value('value')) }
          ignore_exception { varLangField10Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[10]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField11 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[11]").attribute_value('value')) }
          ignore_exception { varLangField11Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[11]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField12 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[12]").attribute_value('value')) }
          ignore_exception { varLangField12Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[12]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField13 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[13]").attribute_value('value')) }
          ignore_exception { varLangField13Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[13]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField14 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[14]").attribute_value('value')) }
          ignore_exception { varLangField14Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[14]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField15 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[15]").attribute_value('value')) }
          ignore_exception { varLangField15Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[15]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField16 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[16]").attribute_value('value')) }
          ignore_exception { varLangField16Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[16]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField17 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[17]").attribute_value('value')) }
          ignore_exception { varLangField17Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[17]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField18 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[18]").attribute_value('value')) }
          ignore_exception { varLangField18Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[18]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField19 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[19]").attribute_value('value')) }
          ignore_exception { varLangField19Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[19]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField20 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[20]").attribute_value('value')) }
          ignore_exception { varLangField20Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[20]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField21 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[21]").attribute_value('value')) }
          ignore_exception { varLangField21Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[21]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField22 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[22]").attribute_value('value')) }
          ignore_exception { varLangField22Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[22]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField23 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[23]").attribute_value('value')) }
          ignore_exception { varLangField23Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[23]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField24 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[24]").attribute_value('value')) }
          ignore_exception { varLangField24Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[24]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField25 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[25]").attribute_value('value')) }
          ignore_exception { varLangField25Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[25]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField26 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[26]").attribute_value('value')) }
          ignore_exception { varLangField26Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[26]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField27 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[27]").attribute_value('value')) }
          ignore_exception { varLangField27Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[27]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField28 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[28]").attribute_value('value')) }
          ignore_exception { varLangField28Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[28]/following::label[1]").attribute_value('textContent')) }
          ignore_exception { varLangField29 = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[29]").attribute_value('value')) }
          ignore_exception { varLangField29Val = con.quote(node.element(:xpath,"(//input[contains(@id,'filterLang')])[29]/following::label[1]").attribute_value('textContent')) }
          ...
          ignore_exception { h11 = con.quote(node.element(:xpath,"(//h1)[1]").attribute_value('textContent')) }
          ignore_exception { h12 = con.quote(node.element(:xpath,"(//h1)[2]").attribute_value('textContent')) }
...
#          ignore_exception { value02_Value = con.quote(@browser.element(:xpath,"//select[@id='review_score_filter']/option[@data-dist='5']").text) }
          ignore_exception { value10_Value = con.quote(node.element(:xpath,"//ul[@id='review_list_score_distribution']//li[1]//p[contains(@class,'review_score_value')]").attribute_value('textContent')) }
          ignore_exception { value08_Value = con.quote(node.element(:xpath,"//ul[@id='review_list_score_distribution']//li[2]//p[contains(@class,'review_score_value')]").attribute_value('textContent')) }
          ignore_exception { value06_Value = con.quote(node.element(:xpath,"//ul[@id='review_list_score_distribution']//li[3]//p[contains(@class,'review_score_value')]").attribute_value('textContent')) }
          ignore_exception { value04_Value = con.quote(node.element(:xpath,"//ul[@id='review_list_score_distribution']//li[4]//p[contains(@class,'review_score_value')]").attribute_value('textContent')) }
          ignore_exception { value02_Value = con.quote(node.element(:xpath,"//ul[@id='review_list_score_distribution']//li[5]//p[contains(@class,'review_score_value')]").attribute_value('textContent')) }
          ignore_exception { varLangField01 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[01]").attribute_value('textContent')) }
          ignore_exception { varLangField02 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[02]").attribute_value('textContent')) }
          ignore_exception { varLangField03 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[03]").attribute_value('textContent')) }
          ignore_exception { varLangField04 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[04]").attribute_value('textContent')) }
          ignore_exception { varLangField05 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[05]").attribute_value('textContent')) }
          ignore_exception { varLangField06 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[06]").attribute_value('textContent')) }
          ignore_exception { varLangField07 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[07]").attribute_value('textContent')) }
          ignore_exception { varLangField08 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[08]").attribute_value('textContent')) }
          ignore_exception { varLangField09 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[09]").attribute_value('textContent')) }
          ignore_exception { varLangField10 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[10]").attribute_value('textContent')) }
          ignore_exception { varLangField11 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[11]").attribute_value('textContent')) }
          ignore_exception { varLangField12 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[12]").attribute_value('textContent')) }
          ignore_exception { varLangField13 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[13]").attribute_value('textContent')) }
          ignore_exception { varLangField14 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[14]").attribute_value('textContent')) }
          ignore_exception { varLangField15 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[15]").attribute_value('textContent')) }
          ignore_exception { varLangField16 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[16]").attribute_value('textContent')) }
          ignore_exception { varLangField17 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[17]").attribute_value('textContent')) }
          ignore_exception { varLangField18 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[18]").attribute_value('textContent')) }
          ignore_exception { varLangField19 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[19]").attribute_value('textContent')) }
          ignore_exception { varLangField20 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[20]").attribute_value('textContent')) }
          ignore_exception { varLangField21 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[21]").attribute_value('textContent')) }
          ignore_exception { varLangField22 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[22]").attribute_value('textContent')) }
          ignore_exception { varLangField23 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[23]").attribute_value('textContent')) }
          ignore_exception { varLangField24 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[24]").attribute_value('textContent')) }
          ignore_exception { varLangField25 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[25]").attribute_value('textContent')) }
          ignore_exception { varLangField26 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[26]").attribute_value('textContent')) }
          ignore_exception { varLangField27 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[27]").attribute_value('textContent')) }
          ignore_exception { varLangField28 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[28]").attribute_value('textContent')) }
          ignore_exception { varLangField29 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[29]").attribute_value('textContent')) }
          ignore_exception { varLangField30 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[30]").attribute_value('textContent')) }
          ignore_exception { varLangField31 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[31]").attribute_value('textContent')) }
          ignore_exception { varLangField32 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[32]").attribute_value('textContent')) }
          ignore_exception { varLangField33 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[33]").attribute_value('textContent')) }
          ignore_exception { varLangField34 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[34]").attribute_value('textContent')) }
          ignore_exception { varLangField35 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[35]").attribute_value('textContent')) }
          ignore_exception { varLangField36 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[36]").attribute_value('textContent')) }
          ignore_exception { varLangField37 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[37]").attribute_value('textContent')) }
          ignore_exception { varLangField38 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[38]").attribute_value('textContent')) }
          ignore_exception { varLangField39 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[39]").attribute_value('textContent')) }
          ignore_exception { varLangField40 = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[40]").attribute_value('textContent')) }
          ignore_exception { varLangField01Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[01]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField02Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[02]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField03Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[03]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField04Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[04]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField05Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[05]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField06Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[06]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField07Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[07]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField08Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[08]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField09Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[09]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField10Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[10]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField11Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[11]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField12Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[12]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField13Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[13]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField14Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[14]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField15Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[15]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField16Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[16]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField17Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[17]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField18Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[18]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField19Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[19]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField20Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[20]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField21Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[21]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField22Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[22]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField23Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[23]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField24Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[24]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField25Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[25]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField26Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[26]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField27Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[27]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField28Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[28]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField29Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[29]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField30Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[30]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField31Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[31]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField32Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[32]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField33Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[33]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField34Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[34]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField35Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[35]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField36Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[36]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField37Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[37]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField38Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[38]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField39Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[39]/following-sibling::*[1]").attribute_value('textContent')) }
          ignore_exception { varLangField40Val = con.quote(node.element(:xpath,"((//*[@class='language_filter_values'])[last()]//*[@class='language_name'])[40]/following-sibling::*[1]").attribute_value('textContent')) }
          ...
          ignore_exception { breadcrumb01Val = con.quote(node.element(:xpath,"//*[@id='breadcrumb']/ol/li[1]/div/a").attribute_value('textContent')) }
          ignore_exception { breadcrumb02Val = con.quote(node.element(:xpath,"//*[@id='breadcrumb']/ol/li[2]/div/a").attribute_value('textContent')) }
          ignore_exception { breadcrumb03Val = con.quote(node.element(:xpath,"//*[@id='breadcrumb']/ol/li[3]/div/a").attribute_value('textContent')) }
          ignore_exception { breadcrumb04Val = con.quote(node.element(:xpath,"//*[@id='breadcrumb']/ol/li[4]/div/a").attribute_value('textContent')) }
          ignore_exception { breadcrumb05Val = con.quote(node.element(:xpath,"//*[@id='breadcrumb']/ol/li[5]/div/a").attribute_value('textContent')) }
          ignore_exception { breadcrumb06Val = con.quote(node.element(:xpath,"//*[@id='breadcrumb']/ol/li[6]/div/a").attribute_value('textContent')) }
          ignore_exception { breadcrumb07Val = con.quote(node.element(:xpath,"//*[@id='breadcrumb']/ol/li[7]/div/a").attribute_value('textContent')) }
          ignore_exception { geoData = con.quote(node.element(:xpath,"//a[@id='hotel_sidebar_static_map']").attribute_value('data-atlas-latlng')) }
          ignore_exception { score = con.quote(node.element(:xpath,"//*[contains(@id,'hp-gallery-scorecard')]//*[@class='bui-review-score__badge']").attribute_value('textContent')) }
          ignore_exception { varDimField01 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[1]").attribute_value('textContent')) }
          ignore_exception { varDimField02 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[2]").attribute_value('textContent')) }
          ignore_exception { varDimField03 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[3]").attribute_value('textContent')) }
          ignore_exception { varDimField04 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[4]").attribute_value('textContent')) }
          ignore_exception { varDimField05 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[5]").attribute_value('textContent')) }
          ignore_exception { varDimField06 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[6]").attribute_value('textContent')) }
          ignore_exception { varDimField07 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[7]").attribute_value('textContent')) }
          ignore_exception { varDimField08 = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[contains(@class,'title')])[8]").attribute_value('textContent')) }
          ignore_exception { varDimField01Val = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[not(contains(@class,'title'))])[1]").attribute_value('textContent')) }
          ignore_exception { varDimField02Val = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[not(contains(@class,'title'))])[2]").attribute_value('textContent')) }
          ignore_exception { varDimField03Val = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[not(contains(@class,'title'))])[3]").attribute_value('textContent')) }
          ignore_exception { varDimField04Val = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[not(contains(@class,'title'))])[4]").attribute_value('textContent')) }
          ignore_exception { varDimField05Val = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[not(contains(@class,'title'))])[5]").attribute_value('textContent')) }
          ignore_exception { varDimField06Val = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[not(contains(@class,'title'))])[6]").attribute_value('textContent')) }
          ignore_exception { varDimField07Val = con.quote(node.element(:xpath,"(//*[starts-with(@class,'v2_review-scores')]//ul/li/div/span[not(contains(@class,'title'))])[7]").attribute_value('textContent')) }
...
#INTRODUCIR PATH COLECCIÓN ITEMS
      ...
      ignore_exception { c08 = con.quote(node.element(:xpath,"//div[contains(@class,' h4 ')]").attribute_value('textContent')) }
      ignore_exception { c09 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[@data-value='5']/span[2]").attribute_value('textContent')) }
      ignore_exception { c10 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[@data-value='4']/span[2]").attribute_value('textContent')) }
      ignore_exception { c11 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[@data-value='3']/span[2]").attribute_value('textContent')) }
      ignore_exception { c12 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[@data-value='2']/span[2]").attribute_value('textContent')) }
      ignore_exception { c13 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[@data-value='1']/span[2]").attribute_value('textContent')) }
      ignore_exception { c14 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[1]/input").attribute_value('checked')) }
      ignore_exception { c15 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[2]/input").attribute_value('checked')) }
      ignore_exception { c16 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[3]/input").attribute_value('checked')) }
      ignore_exception { c17 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[4]/input").attribute_value('checked')) }
      ignore_exception { c18 = con.quote(node.element(:xpath,"(//div[@data-param='trating'])[1]/*[5]/input").attribute_value('checked')) }
      ignore_exception { c19 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSegment')])[1]").attribute_value('checked')) }
      ignore_exception { c20 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSegment')])[2]").attribute_value('checked')) }
      ignore_exception { c21 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSegment')])[3]").attribute_value('checked')) }
      ignore_exception { c22 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSegment')])[4]").attribute_value('checked')) }
      ignore_exception { c23 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSegment')])[5]").attribute_value('checked')) }
      ignore_exception { c24 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSeasons')])[1]").attribute_value('checked')) }
      ignore_exception { c25 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSeason')])[2]").attribute_value('checked')) }
      ignore_exception { c26 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSeason')])[3]").attribute_value('checked')) }
      ignore_exception { c27 = con.quote(node.element(:xpath,"(//input[contains(@id,'filters_detail_checkbox_filterSeason')])[4]").attribute_value('checked')) }
      ignore_exception { c28 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[1]/input").attribute_value('value')) }
      ignore_exception { c29 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[1]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c30 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[2]/input").attribute_value('value')) }
      ignore_exception { c31 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[2]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c32 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[3]/input").attribute_value('value')) }
      ignore_exception { c33 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[3]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c34 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[4]/input").attribute_value('value')) }
      ignore_exception { c35 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[4]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c36 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[5]/input").attribute_value('value')) }
      ignore_exception { c37 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[5]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c38 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[6]/input").attribute_value('value')) }
      ignore_exception { c39 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[6]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c40 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[7]/input").attribute_value('value')) }
      ignore_exception { c41 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[7]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c42 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[8]/input").attribute_value('value')) }
      ignore_exception { c43 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[8]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c44 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[9]/input").attribute_value('value')) }
      ignore_exception { c45 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[9]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c46 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[10]/input").attribute_value('value')) }
      ignore_exception { c47 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[10]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c48 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[11]/input").attribute_value('value')) }
      ignore_exception { c49 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[11]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c50 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[12]/input").attribute_value('value')) }
      ignore_exception { c51 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[12]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c52 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[13]/input").attribute_value('value')) }
      ignore_exception { c53 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[13]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c54 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[14]/input").attribute_value('value')) }
      ignore_exception { c55 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[14]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c56 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[15]/input").attribute_value('value')) }
      ignore_exception { c57 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[15]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c58 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[16]/input").attribute_value('value')) }
      ignore_exception { c59 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[16]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c60 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[17]/input").attribute_value('value')) }
      ignore_exception { c61 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[17]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c62 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[18]/input").attribute_value('value')) }
      ignore_exception { c63 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[18]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c64 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[19]/input").attribute_value('value')) }
      ignore_exception { c65 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[19]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c66 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[20]/input").attribute_value('value')) }
      ignore_exception { c67 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[20]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c68 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[21]/input").attribute_value('value')) }
      ignore_exception { c69 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[21]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c70 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[22]/input").attribute_value('value')) }
      ignore_exception { c71 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[22]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c72 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[23]/input").attribute_value('value')) }
      ignore_exception { c73 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[23]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c74 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[24]/input").attribute_value('value')) }
      ignore_exception { c75 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[24]/span[@class='count']").attribute_value('textContent')) }
      ignore_exception { c76 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[25]/input").attribute_value('value')) }
      ignore_exception { c77 = con.quote(node.element(:xpath,"(//label[contains(@for,'filterLang')])[25]/span[@class='count']").attribute_value('textContent')) }
